...
PARAM <- list()
PARAM$experimento <- "FINAL_EXP_1_ZZ6610"
PARAM$exp_input <- "FINAL_EXP0_1_HT6510"
...
PARAM$semillas <- c(694061, 773831, 338959, 404779, 549533, 998749,
                    773027, 187843, 807571, 532061, 968827, 354149,
                    681427, 408943, 157427, 965101, 498343, 587473,
                    372067, 504991)
