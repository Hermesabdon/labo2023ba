...
PARAM <- list()
PARAM$experimento <- "FINAL_EXP_1_TS6410"

PARAM$exp_input <- "FINAL_EXP_1_FE6310"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 202002,
...
PARAM$train$semilla <- 549533 # cambiar por su propia semilla  !!!
