...
PARAM <- list()
PARAM$experimento <- "FINAL_EXP_1_FE6310"

PARAM$exp_input <- "FINAL_EXP_1_DR6210"
...
PARAM$RandomForest$semilla <- 549533 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 549533
