...
PARAM$ksemillas <-c(100129, 100151, 100153, 100213, 200029)
...
archivo_salida <- "./exp/HT2021/gridsearch_bin_001.txt"
...
for (vmax_depth in c(7, 9, 8, 10, 12, 14)) {
  for (vmin_split in c(900, 800, 700, 600, 300)) {
    for (minbucket in c(85, 105, 90, 100, 50)) {
      for (vcp in c(-1, -0.5, -0.3, -0.4)) {
