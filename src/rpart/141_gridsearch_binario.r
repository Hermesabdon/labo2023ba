...
# particionar( data=dataset, division=c(70,30), agrupa=clase_
...
#definimos las clases binarias, en este caso usaremos baja+2 = TRUE, baja+1 = FALSE, continua = FALSE
dataset[, clase_binaria := ifelse(clase_ternaria == "BAJA+2", TRUE, FALSE)]
...
archivo_salida <- "./exp/HT2020/gridsearch_bin_01.txt"
"
...
for (vmax_depth in c(4, 5, 6, 7, 8, 9, 10)) {
  for (vmin_split in c(300, 350, 400, 450, 500, 550, 600, 650, 700)) {
    for (vcp in c(-0.3, -0.4, -0.5, 0.3)) {
