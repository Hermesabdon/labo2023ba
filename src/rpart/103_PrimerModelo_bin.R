...
#modifico la columna clase ternaria y cambio los valores de BAJA+2 = pos, BAJA+1 = neg y CONTINUA = neg, Continua =neg
...
#print(dataset[, .N, by = clase_binaria])
...
modelo <- rpart(
  ...
  minbucket = 90, # tamaño minimo de una hoja
...
fwrite(dapply[, list(numero_de_cliente, Predicted)],
  file = "./exp/KA2001/K103_PrimerModeloBinario_6.csv",
  sep = ","
)
